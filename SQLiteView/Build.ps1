<#
.SYNOPSIS
    Quick Build Script for SQLiteView

.DESCRIPTION
    Builds the SQLiteView project using CMake.
...
Write-Host ""
Write-Host "🔨 Building SQLiteView ($Configuration)..." -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $dllPath = Join-Path $BuildDir "$Configuration\SQLiteView.dll"
